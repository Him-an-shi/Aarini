...
class TestErrorHandlers:
    ...
    def test_403_handler(self, client, auth_headers):
        ...
        # Assuming an endpoint that checks role/permission restrictions
    ...
    def test_429_handler(self, client, auth_headers):
        ...
        # Fire multiple requests quickly or mock rate limiter if configured
        ...
        if rate_limited_resp:
            ...
            # Fallback assertion if rate limit threshold is higher in test config
            assert True
    ...
    def test_500_handler(self, client, auth_headers):
        ...
        with patch("app.api.cycles.get_cycles", side_effect=Exception("Database crash")):
            ...
            # Ensure raw traceback is not exposed in the response
