    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        >
          ...
          <View style={styles.exportInfo}>
            ...
            <Text style={styles.exportDesc}>
              Human-friendly text format for sharing or printing
            </Text>
          </View>
          {exporting === 'text' ? (
        ...
        <Text style={styles.disclaimer}>
          Your data is exported as-is from local storage and server records. Exported files are
          unencrypted - handle them with care.
        </Text>
      </ScrollView>
    </SafeAreaView>
  )
