        ...
        >
          <View style={styles.contentWrapper}>
            ...
            <View style={styles.header}>
              ...
              <Text style={[typography.bodyLarge, styles.subtitle]}>{t('login.subtitle')}</Text>
              {sessionExpired && (
                <View
                ...
                >
                  <Text style={styles.sessionAlertText}>{t('login.sessionExpired')}</Text>
                </View>
              )}
            </View>
            ...
            <View style={styles.form}>
              ...
              <Button
                ...
                style={[
                  styles.submitButton,
                  { marginTop: 12, backgroundColor: '#DB4437', borderColor: '#DB4437' },
                ]}
              />

              <View style={styles.demoBanner} importantForAccessibility="no">
                <Text style={styles.demoText}>{t('login.demoHint')}</Text>
              </View>
            </View>
