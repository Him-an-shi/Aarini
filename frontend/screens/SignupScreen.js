...
export const SignupScreen = ({ navigation }) => {
  ...
  const handleRegister = useCallback(async () => {
    ...
    const success = await signup(name, email, password, age, cycleLength)
        ...
        >
          ...
          <View style={styles.header}>
            ...
            <Text style={[typography.bodyLarge, styles.subtitle]}>
              {step === 1 ? t('signup.subtitle') : t('signup.cycleSubtitle')}
            </Text>
          </View>
            ...
            {step === 1 ? (
              ...
              <View>
                <InputField
                  ...
                  onChangeText={(text) => {
                    setName(text)
                    step1Validation.handleChange('name', text)
                  }}
                ...
                <InputField
                  ...
                  onChangeText={(text) => {
                    setEmail(text)
                    step1Validation.handleChange('email', text)
                  }}
                ...
                {passwordStrength && (
                  <View
                    ...
                    accessibilityLabel={`Password strength: ${passwordStrength}`}
                  >
                    <View style={{ flexDirection: 'row', marginBottom: 4 }}>
                      ...
                      <View
                        style={{
                          ...
                          marginHorizontal: 2,
                          backgroundColor:
                            passwordStrength === 'Strong' ? colors.successDark : colors.border,
                        }}
                      />
                    </View>
                    <Text
              ...
              <View>
                <InputField
                  ...
                  onChangeText={(text) => {
                    setAge(text)
                    step2Validation.handleChange('age', text)
                  }}
                ...
                <InputField
                  ...
                  onChangeText={(text) => {
                    setCycleLength(text)
                    step2Validation.handleChange('cycleLength', text)
                  }}
                ...
                <Text style={styles.helperText}>
                  💡 Average cycle duration spans 25-35 days. If you are irregular or unsure, you
                  can leave it as 28 and adjust it anytime in settings.
                </Text>
